...
public class ObtenerTareasStepsDefinition extends GenericStepsDefinition {
    ...
    public void obtiene_una_respuesta_no_autorizada() {
        assertEquals(HttpStatus.FORBIDDEN.value(), getStatusCode()); 
    }
